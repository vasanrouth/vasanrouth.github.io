...
! function(t, e) {
    ...
    function In(e, n, i) {
        var t, r, o = {};
        if (k(n) && (n = n.options), n.extends && (e = In(e, n.extends, i)), n.mixins)
    ...
    Jn.util = Kn, Jn.data = "__uikit__", Jn.prefix = "uk-", Jn.options = {}, Jn.version = "3.6.15", ti = (Zn = Jn).data, Zn.use = function(t) {
            ...
            (t = t || {}).data = function(t, e) {
                ...
                if (n = y(n) ? D(i) ? void 0 : n.slice(0, i.length).reduce(function(t, e, n) {
                    ...
                    for (var o in n) O(n[o]) ? delete n[o] : n[o] = r[o] ? li(r[o], n[o]) : n[o];
                return n
                ...
                toggleElement: function(e, s, a) {
                    ...
                    return new ce(function(t) {
                        return ce.all(W(e).map(function(t) {
                            ...
                            var o, n = (k(a) ? a : !1 !== a && u.hasAnimation ? u.hasTransition ? pi(u) : (o = u, function(t, e) {
                                    en.cancel(t);
                                    var n = o.animation,
                                        i = o.duration,
                                        r = o._toggle;
                ...
                show: function(t, e) {
                    ...
                    if (void 0 === t && (t = this.toggle), void 0 === e && (e = !0), this.isToggled() && t && this.toggle && t.$el !== this.toggle.$el && this.hide(!1), this.toggle = t, this.clearTimers(), !this.isActive()) {
                        if (xi) {
                            ...
                            for (; xi && n !== xi && !Nt(this.$el, xi.$el);)(n = xi).hide(!1)
                        }
                    ...
                    return {
                        ...
                        columns: function(t) {
                            for (var e = [], n = 0; n < t.length; n++)
                                for (var i = Ei(t[n], "left", "right"), r = 0; r < i.length; r++) e[r] = e[r] ? e[r].concat(i[r]) : i[r];
                    ...
                    return Pi(this.src).then(function(t) {
                        return function(t, e) {
                            e && w(t, "<symbol") && (t = function(t, e) {
                                if (!Li[t]) {
                                    var n;
                                    for (Li[t] = {}, Hi.lastIndex = 0; n = Hi.exec(t);) Li[t][n[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + n[1] + "svg>"
                                }
                                return Li[t][e]
                            }(t, e) || t);
